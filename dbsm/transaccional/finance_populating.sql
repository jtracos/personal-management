...
(1, 2, 2, 1, 3, '2024-01-07', '2023-02-05', '2024-02-05',null,null, 1, 'Licuadora ninja'),
(1, 3, 2, 1, 3, '2024-01-07', '2023-12-19', '2024-12-19',null, 21, 1,'Star link'),
(1, 4, 2, 1, 3, '2024-01-08', '2024-01-15', null,null,15, 1,'Internet'),
(1, 5, 1, 1, -1, '2024-01-12', '2024-01-12', null,null,15, 1,'membresia crunchy roll'),
(1, 6, 1, 1, 3, '2024-01-12', '2023-12-20', null,null, 21,, 1,'Servicio star link'),
(1, 7, 2, 1, 3, '2024-01-12', '2024-01-01', '2025-01-01',null,null, 1,'IPhone'),
(1, 8, 2, 1, 3, '2024-01-15', '2024-01-15', '2025-01-14',null,15, 1,'Moto'),
(1, 9, 5, 2, 3, '2025-02-07', null, null, null, 20, 1, 'Renta Internet')
;

INSERT INTO EVENT(user_id,event_id,amount,update_date, ind_active)
VALUES
(1, 1, 10118,'2024-01-07', 0),
(1, 1, 11268,'2024-01-12', 1),
(1, 2, 246, '2024-01-07', 0),
(1, 3, 514, '2024-01-07', 0),
(1, 4, 400, '2024-01-07', 0),
(1, 5, 99, '2024-01-07', 0),
(1, 6, 1100, '2024-01-07', 1),
(1, 7, 675, '2024-01-07', 0),
(1, 8, 1170, '2024-01-07', 0),
(1, 9, 950,'2025-02-07', 1)
;